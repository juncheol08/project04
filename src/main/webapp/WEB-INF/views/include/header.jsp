...
<%--    <nav class="navbar is-dark is-fixed-top nav-bg has-border-bottom" role="navigation" aria-label="main navigation">--%>
    <nav class="navbar is-dark nav-bg has-border-bottom" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
            <a class="navbar-item" href="${path2}/">
                <img src="${path2}/resources/img/haebeop_logo.png" width="112" height="28">
            </a>
        ...
        <div class="navbar-start">
            <div class="navbar-item has-dropdown is-hoverable">
                <a href="${path2}/lecture/lectureList.do?category=kor" class="navbar-link is-arrowless">
                    <strong>강의</strong>
                </a>

            </div>
            <div class="navbar-item has-dropdown is-hoverable">
                <a href="${path2}/instructor/instructorList.do" class="navbar-link is-arrowless">
                    <strong>선생님</strong>
                </a>
